...
from constants import LEFT_PANEL_WIDTH, LEGENDARY_GOLD, TEMPLATE_MARKDOWN, TEMPLATE_XML, VERSION
...
class HeaderFrame(ttk.Frame):
    ...
    LEGENDARY_GOLD: str
    repo_prefix_label: ttk.Label
    repo_name_label: ttk.Label
    header_separator: ttk.Frame
...
class LeftPanel(ttk.Frame):
    ...
    def on_format_change(self, event: tk.Event[Any]) -> None:
    ...
    def on_sanitize_urls_toggle(self) -> None:
...
class RightPanel(ttk.Frame):
    ...
    def on_tab_changed(self, event: tk.Event[Any]) -> None:
...
class GitStatusPanel(ttk.Frame):
    ...
    staged_list_frame: ttk.Frame
    staged_list: tk.Listbox
    _staged_btn: ttk.Button
    changes_label: ttk.Label
    changes_body: ttk.Frame
    changes_list_frame: ttk.Frame
    changes_list: tk.Listbox
    _changes_btn: ttk.Button
